...
/** add by Douyu */
EXPORT void *obs_source_get_context_data(obs_source_t *source);
...
EXPORT long obs_source_get_weak_ref(obs_source_t *source);
...
EXPORT void obs_source_render_async_video(obs_source_t *source);
...
EXPORT size_t obs_source_get_async_cache_size(obs_source_t *source);
EXPORT size_t obs_source_get_audio_cache_size(obs_source_t *source);
...
EXPORT void obs_source_release_audio(obs_source_t *source);
...
EXPORT void obs_source_update_directly(obs_source_t *source, obs_data_t *settings);
