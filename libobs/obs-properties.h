...
enum obs_property_type {
    ...
    // Douyu define
    OBS_PROPERTY_DOUYU,     // custom property type
};
...
enum obs_douyu_type {
    OBS_DOUYU_TYPE_INVALID,
    OBS_DOUYU_TYPE_IMAGE_LIST,  // 带图像的列表，ext为图像的地址
};

enum obs_douyu_format {
    OBS_DOUYU_FORMAT_INVALID,
    OBS_DOUYU_FORMAT_INT,       
    OBS_DOUYU_FORMAT_FLOAT,     
    OBS_DOUYU_FORMAT_STRING,    
};
...
EXPORT obs_property_t *obs_properties_add_douyu(obs_properties_t *props,
                        const char *name,
                        const char *description,
...
EXPORT enum obs_douyu_type obs_property_douyu_type(obs_property_t *p);
EXPORT enum obs_douyu_format obs_property_douyu_format(obs_property_t *p);

EXPORT void obs_property_douyu_clear(obs_property_t *p);

EXPORT size_t obs_property_douyu_add_string(obs_property_t *p, const char *name, const char* ext,
    const char *val);
EXPORT size_t obs_property_douyu_add_int(obs_property_t *p, const char *name, const char* ext,
    long long val);
EXPORT size_t obs_property_douyu_add_float(obs_property_t *p, const char *name, const char* ext,
    double val);

EXPORT void obs_property_douyu_insert_string(obs_property_t *p, size_t idx,
    const char *name, const char* ext, const char *val);
EXPORT void obs_property_douyu_insert_int(obs_property_t *p, size_t idx,
    const char *name, const char* ext, long long val);
EXPORT void obs_property_douyu_insert_float(obs_property_t *p, size_t idx,
    const char *name, const char* ext, double val);

EXPORT void obs_property_douyu_item_disable(obs_property_t *p, size_t idx,
    bool disabled);
EXPORT bool obs_property_douyu_item_disabled(obs_property_t *p, size_t idx);

EXPORT void obs_property_douyu_item_remove(obs_property_t *p, size_t idx);

EXPORT size_t obs_property_douyu_item_count(obs_property_t *p);
EXPORT const char *obs_property_douyu_item_name(obs_property_t *p, size_t idx);
EXPORT const char *obs_property_douyu_item_ext(obs_property_t *p, size_t idx);
EXPORT const char *obs_property_douyu_item_string(obs_property_t *p, size_t idx);
EXPORT long long obs_property_douyu_item_int(obs_property_t *p, size_t idx);
EXPORT double obs_property_douyu_item_float(obs_property_t *p, size_t idx);
