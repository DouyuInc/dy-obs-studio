...
EXPORT void obs_data_set_buffer(obs_data_t *data, const char *name,
	uint8_t *buf, size_t len);

EXPORT void obs_data_get_buffer(obs_data_t *data, const char *name,
	uint8_t **buf, size_t* len);
...
EXPORT void obs_data_item_get_buffer(obs_data_item_t *item, uint8_t** buf, size_t* len);
